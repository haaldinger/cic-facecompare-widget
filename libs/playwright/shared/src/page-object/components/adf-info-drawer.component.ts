...
export class AdfInfoDrawer extends BaseComponent {
    ...
    processInstanceIdValueLocator = this.getElementByAutomationId('card-textitem-label-processInstanceId');
    changeAssigneeButtonLocator = this.getElementByAutomationId('card-textitem-clickable-icon-assignee');
}
