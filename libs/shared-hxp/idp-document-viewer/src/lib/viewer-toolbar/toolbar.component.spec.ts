...
describe('ToolbarComponent', () => {
    ...
    it('should group toolbar items by their position', (done) => {
        component.orderedToolbarItems$.subscribe((toolbarData) => {
            ...
            expect(toolbarData.end.length).toBe(5);
            ...
            expect(toolbarData.end[3].type).toBe(ToolbarItemTypes.RedactionToggle);
            expect(toolbarData.end[4].type).toBe(ToolbarItemTypes.RedactionDrawMode);
