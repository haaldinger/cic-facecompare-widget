...
export const BreadcrumbEntryTypes = {
    PARENT: 'PARENT',
    SELF: 'SELF',
} as const;

export type BreadcrumbEntryTypes = (typeof BreadcrumbEntryTypes)[keyof typeof BreadcrumbEntryTypes];
...
export class BreadcrumbDataService {
    ...
    private findAccessibleParent(ancestors: Document[], breadcrumbEntry: BreadcrumbEntry) {
        ...
        const parentWithPermission = [...ancestors].reverse().find(
            (ancestor) =>
                ancestor &&
