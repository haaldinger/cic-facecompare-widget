        ...
        rules: {
            '@nx/enforce-module-boundaries': [
                'error',
                {
                    ...
                    depConstraints: [
                        {
                            sourceTag: 'scope:workspace-hxp-content-services-extension-content-browser-feature-shell',
                            onlyDependOnLibsWithTags: [
                                'scope:adf-enterprise-adf-hx-content-services-features',
                                'scope:adf-enterprise-adf-hx-content-services',
                                'scope:adf-enterprise-adf-hx-content-services-api',
                                'scope:adf-enterprise-adf-hx-content-services-icons',
                                'scope:workspace-hxp-content-services-search-feature-shell',
