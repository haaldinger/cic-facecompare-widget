...
describe('ContentUploadListComponent', () => {
    ...
    it('should not render any upload list if no data is provided', () => {
        ...
        expect(uploadLists).toHaveLength(0);
    });
    ...
    it('should render uncategorized upload list on data changes', () => {
        ...
        expect(uploadLists).toHaveLength(1);
    ...
    it('should render multiple upload lists on data changes based on document categories', () => {
        ...
        expect(uploadLists).toHaveLength(2);
    ...
    it('should select uploads from different categories', async () => {
        ...
        expect(table.nativeElement.getAttribute('id')).toBe('table-SysFile');
        expect(rows).toHaveLength(2);
        expect(table.componentInstance.selection).toHaveLength(1);
    ...
    it('should display file upload progress', () => {
        ...
        expect(progressBar.nativeElement.classList).not.toContain('hxp-workspace-upload-list__container__table__title-column__progress-bar--hidden');
        ...
        expect(progressBar.nativeElement.classList).toContain('hxp-workspace-upload-list__container__table__title-column__progress-bar--hidden');
    });
