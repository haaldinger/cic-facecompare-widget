...
describe('CancelFolderDialogComponent', () => {
    ...
    afterEach(() => {
        (dialogData?.close as jest.Mock).mockClear();
    ...
    it('should close the cancel dialog when `continue creating` is clicked', () => {
        ...
        const continueButton = fixture.debugElement.query(By.css('[data-automation-id="hxp-cancel-dialog-reject-button"]'));
    ...
    it('should close the both cancel and create folder dialog when `cancel` is clicked', () => {
        ...
        const confirmButton = fixture.debugElement.query(By.css('[data-automation-id="hxp-cancel-dialog-confirm-button"]'));
