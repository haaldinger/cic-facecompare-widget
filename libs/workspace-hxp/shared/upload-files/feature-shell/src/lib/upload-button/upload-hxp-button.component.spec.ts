...
describe('UploadButtonComponent', () => {
    ...
    beforeEach(async () => {
        ...
        await TestBed.configureTestingModule({
            imports: [CommonModule, MatIconTestingModule, NoopTranslateModule, UploadHxpButtonComponent],
            providers: [
    ...
    it('should by default the title of the button get from the JSON file', () => {
        ...
        expect(compiled.querySelector('#upload-single-file-label').textContent.trim()).toEqual('FILE_UPLOAD.BUTTON.UPLOAD_FILE');

        component.multipleFiles = true;
        fixture.detectChanges();
        expect(compiled.querySelector('#upload-multiple-file-label').textContent.trim()).toEqual('FILE_UPLOAD.BUTTON.UPLOAD_FILE');

        component.uploadFolders = true;
        fixture.detectChanges();
        expect(compiled.querySelector('#uploadFolder-label').textContent.trim()).toEqual('FILE_UPLOAD.BUTTON.UPLOAD_FOLDER');
    });
