...
describe('ExtractionResultComponent', () => {
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            imports: [MatDialogModule, HttpClientTestingModule, MetadataPanelComponent, NoopTranslateModule, MatIconTestingModule],
        });
    ...
    it('should set the right result text and style class if field has issue', () => {
        ...
        const iconElement = fixture.debugElement.query(By.css('[data-automation-id="idp-field-extraction-result-icon-has-issue"]'));
        expect(iconElement.nativeElement.classList).toContain('idp-extraction-result__status-indicator--issue');
