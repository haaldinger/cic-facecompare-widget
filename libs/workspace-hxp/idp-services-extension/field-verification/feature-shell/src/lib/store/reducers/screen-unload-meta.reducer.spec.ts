...
describe('screenUnloadMetaReducer', () => {
    ...
    it('should return initial state if action type is screenStateReset', () => {
        const action = systemActions.screenStateReset();
    ...
    it('should call the reducer with the current state and action if action type is not screenStateReset', () => {
        const action = { type: 'UNKNOWN' };
    ...
    it('should return the result of the reducer if action type is not screenStateReset', () => {
        const action = { type: 'UNKNOWN' };
        const state: FieldVerificationRootState = { ...fieldVerificationRootState };
