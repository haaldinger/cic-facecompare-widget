...
const shortcuts: IdpShortcut[] = [
    ...
    },
    {
        key: 'd',
        modifierKeys: [],
        action: IdpShortcutAction.PageCreateCopy,
        category: 'document_operation',
        description: 'IDP_CLASS_VERIFICATION.SHORTCUTS.PAGE_CREATE_COPY',
    },
    {
        key: 'delete',
        modifierKeys: [ModifierKey.shiftKey],
    ...
    },
    {
        key: 'x',
        modifierKeys: [ModifierKey.ctrlKey],
        action: IdpShortcutAction.PageCut,
        category: 'document_operation',
        description: 'IDP_CLASS_VERIFICATION.SHORTCUTS.PAGE_CUT',
    },
    {
        key: 'x',
        modifierKeys: [ModifierKey.shiftKey],
        action: IdpShortcutAction.PageCutClear,
        category: 'document_operation',
        description: 'IDP_CLASS_VERIFICATION.SHORTCUTS.PAGE_CUT_CLEAR',
    },
    {
        key: '+',
        modifierKeys: [ModifierKey.ctrlKey, ModifierKey.shiftKey],
        action: IdpShortcutAction.OpenContextMenu,
        category: 'document_operation',
        description: 'IDP_CLASS_VERIFICATION.SHORTCUTS.OPEN_CONTEXT_MENU',
    },
    {
        key: 'L',
        modifierKeys: [ModifierKey.shiftKey],
        action: IdpShortcutAction.ViewerToggleLayout,
        category: 'viewer_general',
        description: 'IDP_CLASS_VERIFICATION.SHORTCUTS.VIEWER_TOGGLE_LAYOUT',
    },
    {
        key: '+',
        ...
        category: 'viewer_general',
        description: 'IDP_CLASS_VERIFICATION.SHORTCUTS.VIEWER_ZOOM_IN',
    },
    {
        key: '-',
        modifierKeys: [ModifierKey.shiftKey, ModifierKey.altKey],
        ...
        category: 'viewer_general',
        description: 'IDP_CLASS_VERIFICATION.SHORTCUTS.VIEWER_ZOOM_OUT',
    },
    {
        key: 'R',
        modifierKeys: [ModifierKey.shiftKey],
        ...
        category: 'viewer_general',
        description: 'IDP_CLASS_VERIFICATION.SHORTCUTS.VIEWER_ROTATE',
    },
    {
        key: 'F',
        modifierKeys: [ModifierKey.shiftKey],
        ...
        category: 'viewer_general',
        description: 'IDP_CLASS_VERIFICATION.SHORTCUTS.VIEWER_FULLSCREEN',
    },
];
