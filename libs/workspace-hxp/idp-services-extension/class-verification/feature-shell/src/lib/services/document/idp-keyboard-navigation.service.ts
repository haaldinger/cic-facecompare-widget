...
export const IdpKeyboardNavActionTypeInternal = {
    ActiveItemChanged: 'ActiveItemChanged',
    Expand: 'Expand',
    Collapse: 'Collapse',
} as const;
export type IdpKeyboardNavActionTypeInternal = (typeof IdpKeyboardNavActionTypeInternal)[keyof typeof IdpKeyboardNavActionTypeInternal];
...
@Injectable()
export class IdpKeyboardNavigationService {
    ...
    private readonly multiSelectActions: IdpShortcutAction[] = [
