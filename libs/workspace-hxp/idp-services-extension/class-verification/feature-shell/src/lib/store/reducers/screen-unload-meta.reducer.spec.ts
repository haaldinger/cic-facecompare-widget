...
describe('screenUnloadMetaReducer', () => {
    ...
    it('should return initial state when action is screenStateReset', () => {
        ...
        state = reducer(state, systemActions.screenStateReset);
        expect(state).toEqual(initialClassVerificationRootState);
    });

    it('should return the reducer when state is supplied and action is not screenStateReset', () => {
