...
export class DispositionSearchFilterComponent extends DateSearchGenericFilterBase<DispositionSearchFilterService> {
    private readonly dispositionSearchFilterService = inject(DispositionSearchFilterService);

    protected override getService(): DispositionSearchFilterService {
        return this.dispositionSearchFilterService;
    }

    constructor() {
        super('GOVERNANCE.SEARCH.FILTERS.DISPOSITION.LABEL');
    }
}
