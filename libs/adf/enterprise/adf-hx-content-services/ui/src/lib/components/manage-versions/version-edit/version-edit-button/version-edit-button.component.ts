...
import { ActionContext, HXP_DOCUMENT_VERSION_EDIT_ACTION_SERVICE } from '@alfresco/adf-hx-content-services/services';
...
export class VersionEditButtonComponent implements OnChanges {
    ...
    private readonly versionEditActionService = inject(HXP_DOCUMENT_VERSION_EDIT_ACTION_SERVICE);
