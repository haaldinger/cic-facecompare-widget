...
describe('FormRulesService', () => {
    ...
    let event: string;
    let createdOrphanedLinkedProcessesService: OrphanedLinkedProcessesService;
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            providers: [
                ...
                MockProvider(StartProcessActionService, {
                    onProcessFinishTrigger$: new Subject<FormProcessFinishEventData>(),
        ...
        createdOrphanedLinkedProcessesService = TestBed.inject(OrphanedLinkedProcessesService);
        service.initialize(formModel);
    });

    it('should clear orphaned processes ids on initialization', () => {
        const clearOrphanedProcessesIdsSpy = jest.spyOn(createdOrphanedLinkedProcessesService, 'clearOrphanedProcessesIds');

        service.initialize(formModel);

        expect(clearOrphanedProcessesIdsSpy).toHaveBeenCalled();
    });
    ...
    describe('handle processes', () => {
        ...
        it('should set form variable on process finish', () => {
            ...
            (startProcessActionService.onProcessFinishTrigger$ as Subject<FormProcessFinishEventData>).next(handleRuleEventOnProcessFinishDataMock);
        ...
        it('should NOT set value on process finish when correlation does not key match', () => {
            ...
            const onProcessFinishDataMockWithWrongCorelation: FormProcessFinishEventData = {
                process: {
            ...
            (startProcessActionService.onProcessFinishTrigger$ as Subject<FormProcessFinishEventData>).next(
