...
import { FormFieldTypes, FormModel, FormVariableModel } from '@alfresco/adf-core';
...
export const getDatatableFormModelMock = (): FormModel => {
    const variables: FormVariableModel[] = [
        {
            id: 'variable1',
            name: 'variable.variable1',
            type: 'text',
            value: '${process.variables.variable1}',
        },
    ];
    ...
    return new FormModel({ fields, variables });
};

export const getFormModelMock = (): FormModel => {
    const variables: FormVariableModel[] = [
        {
            id: 'variable1',
            name: 'variable.variable1',
...
export const getFormDefinitionMock = () => {
    const formDefinitionMock = {
...
export const getFormModelMockForChange = (): FormModel => {
    const variables: FormVariableModel[] = [
        {
            id: 'a8b157ae-4af5-4587-a7f3-e2d98735e014',
            name: 'fvVariable1',
            type: 'string',
            value: null,
        },
    ...
    const fields = [
        {
            ...
            id: '5e751c7c-1969-4807-ba58-506fa274cc53',
            name: 'Section',
            tab: null,
            numberOfColumns: 2,
            fields: {
                ...
                '2': [
                    {
                        id: 'DisplayTextId1',
                        name: 'Display text',
                        type: FormFieldTypes.READONLY_TEXT,
                        isVisible: false,
                        readOnly: false,
                        value: 'test value',
                        visibilityCondition: JSON.stringify({
                            leftType: 'variable',
                            leftValue: 'fvVariable1',
                            operator: '!empty',
                            rightValue: null,
                            rightType: null,
