    ...
    describe('Email address inclusion not requested', () => {
        beforeAll(() => {
            TestBed.configureTestingModule({
                providers: [SharedIdentityFullNamePipe]
            });
            pipe = TestBed.inject(SharedIdentityFullNamePipe);
        });
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                providers: [
                    ...
                    { provide: SHARED_IDENTITY_FULL_NAME_PIPE_INCLUDE_EMAIL, useValue: true }
                ]
            });
            pipe = TestBed.inject(SharedIdentityFullNamePipe);
            user = { email: 'abcXyz@gmail.com' };
    ...
    describe('Pipe parameter prevalence over token', () => {
        it('should include email when injection token is false and pipe parameter is true', () => {
            TestBed.configureTestingModule({
                providers: [
                    SharedIdentityFullNamePipe,
                    { provide: SHARED_IDENTITY_FULL_NAME_PIPE_INCLUDE_EMAIL, useValue: false }
                ]
            });
            pipe = TestBed.inject(SharedIdentityFullNamePipe);
