...
import { ChangeDetectionStrategy, Component, EventEmitter, Input, OnInit, Output, HostListener, input, effect, inject } from '@angular/core';
...
export class DateFilterMenuComponent implements OnInit {
    ...
    get clearSelectionButtonDisabled(): boolean {
        return !this.form.value?.selectedOption || !this.allowEmpty;
    }

    get showClearButtons(): boolean {
