...
export function createTaskProcessDefinitionNameFilter(
...
export function createTaskProcessInstanceIdFilter(processInstanceIds: string[], priority?: number): StringFilter {
...
export function createTaskParentIdFilter(parentIds: string[], priority?: number): StringFilter {
    return new StringFilter({
...
export function createAssigneeFilter(defaultAssignees: IdentityUserModel[], appName: string, priority?: number): UserFilter {
...
export function createPriorityFilter(
    ...
    return new CheckboxFilter({
        ...
        value: defaultPriorities.map((p) => ({
            value: p,
            label: getPriorityLabel(Number.parseInt(p || '', 10)),
            checked: true,
        })),
        options: priorities,
...
export function createDueDateFilter(
    defaultDueDateType: DateCloudFilterType,
...
export function createCompletedByFilter(defaultCompletedByUsers: IdentityUserModel[], appName: string, priority?: number): UserFilter {
    return new UserFilter({
...
export function createTaskNameFilter(defaultNames: string[], priority?: number): StringFilter {
    return new StringFilter({
...
export function createTaskIdFilter(defaultIds: string[], priority?: number): StringFilter {
    return new StringFilter({
...
export function createTaskStatusFilter(defaultStatuses: string[], priority?: number): CheckboxFilter {
    return new CheckboxFilter({
